# The specifications for the full-content-inventory-integrated app (v2)

> **Scope note:** This spec covers the full project. The v2 plans below address **Plan 1 scope only** (monorepo bootstrap + crawler). Plans 2–3 (GWS Sync, AI Summarizer) remain unchanged.
